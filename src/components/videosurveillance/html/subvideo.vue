<template>
    <div class="subvideo"  :style="{'width': numdata.width+'px','height': numdata.height+'px'}">
        <div :id="'a'+index" :style="{'width': numdata.width+'px','height': numdata.height+'px'}"></div>
    </div>
</template>
...
export default {
    ...
    methods:{
        open(){
		    ...
		    CKobject.embedSWF('./static/ckplayer/ckplayer.swf','a'+this.index,'ckplayer_a1',this.numdata.width,this.numdata.height,flashvars,params);;
        },
    },
    watch:{
        numdata:{
